...
<form method="post" action="/user/create-new-comment/<?= $this->getViewData('theme_link') . DIRECTORY_SEPARATOR . $this->getViewData('topic_link') . DIRECTORY_SEPARATOR . $this->getViewData('opinion_id'); ?>">
